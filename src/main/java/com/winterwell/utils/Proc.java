...
public class Proc implements Closeable {
	...
	/**
	 * For long running processes, it is important to call this periodically
	 */
...
//		process.destroy(); Send a polite request to destroy?! Java, what is this nonsense? 
	...
	public String getOutputAndClear() {
		return out.getStringAndClear();
	}
	
	public String getErrorAndClear() {
		// NB: there's a corner-case race condition
		return err==null? "" : err.getStringAndClear();
	}
