...
public class MathUtilsTest extends TestCase {
	...
	@Test public void testRoundSigFig() {
		{
			BigDecimal bDecimal = new BigDecimal(1234.5678);
			BigDecimal bDecimal2 = bDecimal.round(new MathContext(2));
			assert bDecimal2.doubleValue() == 1200;
		}
		{
			BigDecimal bDecimal = new BigDecimal(1264.5678);
			BigDecimal bDecimal2 = bDecimal.round(new MathContext(2));
			assert bDecimal2.doubleValue() == 1300;
		}
	}
